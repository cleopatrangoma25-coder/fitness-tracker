...
const cardVariants = cva(
  'bg-white dark:bg-gray-800 rounded-3xl shadow-soft border border-neutral-200 dark:border-gray-700 hover:shadow-medium transition-all duration-300 backdrop-blur-sm',
  {
    variants: {
      padding: {
        none: 'p-0',
